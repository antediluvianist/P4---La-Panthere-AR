		...
		n = {
			...
			methods: {
				init: function(e) {
					...
					var l = this,
						s = a.unique(l.map(function() {
							return a(this).parents("form")[0]
						}).toArray());
					return a(s).bind("submit", function(e) {
						var i = a(this),
							n = 0,
						...
						r.trigger("submit.validation").trigger("validationLostFocus.validation"), r.each(function(e, t) {
							var i = a(t),
								r = i.parents(".form-group, .checkbox").first();
						...
						a.each(d, function(i, n) {
							...
							if(o = o ? o : "'" + n + "' validation failed <!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message -->", a.each(t.validatorTypes, function(t, i) {
									void 0 === h[t] && (h[t] = []), s || void 0 === e.data("validation" + n + r(i.name)) || (h[t].push(a.extend(!0, {
										name: r(i.name),
										message: o
									}, i.init(e, n))), s = !0)
								...
								"shortcut" === c ? s = !0 : a.each(t.validatorTypes, function(t, i) {
									void 0 === h[t] && (h[t] = []), s || c !== t.toLowerCase() || (e.data("validation" + n + r(i.name), d[i.name.toLowerCase()]), h[c].push(a.extend(d, i.init(e, n))), s = !0)
								})
							}
							s || a.error("Cannot find validation info for '" + n + "'")
						}), l.data("original-contents", l.data("original-contents") ? l.data("original-contents") : l.html()), l.data("original-role", l.data("original-role") ? l.data("original-role") : l.attr("role")), n.data("original-classes", n.data("original-clases") ? n.data("original-classes") : n.attr("class")), e.data("original-aria-invalid", e.data("original-aria-invalid") ? e.data("original-aria-invalid") : e.attr("aria-invalid")), e.bind("validation.validation", function(i, n) {
							var r = o(e),
								l = [];
							return a.each(h, function(i, o) {
								(r || r.length || n && n.includeEmpty || t.validatorTypes[i].blockSubmit && n && n.submitting) && a.each(o, function(a, n) {
									t.validatorTypes[i].validate(e, r, n) && l.push(n.message)
								})
							}), l
